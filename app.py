        ...
        <div id="main-content" class="content-area-wrapper">
            <main class="content-section">
                ...
                <section id="home" class="dashboard-section">
                    ...
                    <!-- Achievements Card -->
                    <div class="card">
                        <h3 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Weekly Achievements 🏆</h3>
                        <div class="data-table-container">
                            <table class="data-table">
                                <thead>
                                    <tr>
            ...
            <section id="daily-schedule" class="dashboard-section hidden">
                ...
                <!-- Morning Routine -->
                <div class="card">
                    <h3 class="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Morning Routine ☀️</h3>
                    <div class="data-table-container">
                        <table class="data-table">
                            <thead>
                                <tr>
                            ...
                            <tbody id="daily-schedule-list">
                                <tr><td colspan="2" class="text-center text-gray-500 dark:text-gray-400 py-4">No daily schedule entries yet.</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="mt-4">
    ...
    <script>
        ...
        async function addStudyPlan() {
            ...
            if (result) {
                ...
                await loadStudyPlans();
                // No direct chart update here, as study plans themselves don't directly map to chart metrics.
                // Chart updates when pomodoro/lectures are done or manual hours added.
            }
        }
